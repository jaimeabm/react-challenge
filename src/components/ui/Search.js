                ...
                <div className="input-group-md">
                    ...
                    <div className="form-group">
                        <div className="icon-addon addon-lg">
                            ...
                            <input type="text" className="form-control input-lg flat" name="search-location" placeholder="Album Name" />
                        </div>
                    </div>
                    <span className="input-group-btn">
                        <button className="btn btn-lg btn-secondary animation text-uppercase" type="button">Search</button>
                    </span>
                </div>
            </form>
        </div>
